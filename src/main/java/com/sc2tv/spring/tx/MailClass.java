...
{
    String smtp = "smpt.mail.ru";
    String imap = "imap.mail.ru";
    String pop3 = "pop.mail.ru";
    ...
    public boolean checkAvailability() throws MessagingException, IOException {
        if(proxyUnit!=null){
        System.setProperty("http.proxyHost", proxyUnit.getHost());
        System.setProperty("http.proxyPort", Integer.toString(proxyUnit.getPort()));}
        Properties properties = System.getProperties();
        Session session = Session.getDefaultInstance(properties);
        Store store = session.getStore("pop3");
        try{store.connect(pop3, email, password);}
